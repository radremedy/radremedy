...
admin = Admin(
    name='RAD Remedy Admin',
    template_mode='bootstrap3',
    base_template='admin/radbase.html',
    index_view=homeview.AdminHomeView())
admin.add_view(resourceview.ResourceView(
    db.session,
    category='Resource',
    name='All',
    endpoint='resourceview',))
admin.add_view(resourceview.ResourceRequiringGeocodingView(
    db.session,
    category='Resource',
    name='Needing Geocoding',
    endpoint='geocode-resourceview'))
admin.add_view(resourceview.ResourceRequiringCategoriesView(
    db.session,
    category='Resource',
    name='Needing Categorization',
    endpoint='category-resourceview'))
admin.add_view(resourceview.ResourceRequiringPopulationsView(
    db.session,
    category='Resource',
    name='Needing Populations',
    endpoint='population-resourceview'))
admin.add_view(resourceview.ResourceRequiringNpiView(
    db.session,
    category='Resource',
    name='Needing NPI',
    endpoint='npi-resourceview'))
admin.add_view(resourceview.SubmittedResourceView(
    db.session,
    category='Resource',
...
admin.add_view(resourceimportview.ResourceImportFilesView(
    resource_path,
    None,
    category='Resource',
    name='CSV Import'))
admin.add_view(resourceimportview.ResourceImportView(
    db.session,
    resource_path))
...
admin.add_view(userview.UserView(
    db.session,
    category='User',
    name='Users',
    endpoint='userview'))
admin.add_view(loginhistoryview.LoginHistoryView(
    db.session,
    category='User',
    name='Login History',
    endpoint='loginhistoryview'))

admin.add_view(categoryview.CategoryView(
    db.session,
    category='Category',
    name='Categories',
    endpoint='categoryview'))
admin.add_view(categorygroupview.CategoryGroupView(
    db.session,
    category='Category',
    name='Groups',
    endpoint='categorygroupview'))

admin.add_view(categoryview.CategoryMergeView(
    db.session))

admin.add_view(populationview.PopulationView(
    db.session,
    category='Population',
    name='Populations',
    endpoint='populationview'))
admin.add_view(populationgroupview.PopulationGroupView(
    db.session,
    category='Population',
    name='Groups',
    endpoint='populationgroupview'))

admin.add_view(reviewview.ReviewView(
    db.session,
    endpoint='reviewview'))
